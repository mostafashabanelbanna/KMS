...
// ** Store & Actions
import { addDefinition, resetCreateResponse, updateDefinition, resetUpdateResponse } from './store/action'
import { useDispatch, useSelector  } from 'react-redux'
import Toastr from '../../../containers/toastr/Toastr'

const SidebarNewDefinition = ({ open, toggleSidebar, selectedDefinition, documentIssueId }) => {
  ...
  useEffect(() => {
    if (!selectedDefinition.publishDate) {
      setPublishDate(moment(new Date().toLocaleDateString(), "MM-DD-YYYY")
      .format("YYYY-MM-DD")
      .replace(/[٠-٩]/g, (d) => "٠١٢٣٤٥٦٧٨٩".indexOf(d)))
    } else {
      setPublishDate(selectedDefinition.publishDate)
    }
  ...
  }, [selectedDefinition.publishDate])
  ...
  return (
    <Sidebar
      size='lg'
      open={open}
      title={selectedDefinition.id ? intl.formatMessage({id: "Edit"}) : intl.formatMessage({id: "Add"})}
          ...
          <Col md={6}>
            <FormGroup>
              ...
              <Input
                name='titleA'
                id='titleA'
                defaultValue={selectedDefinition ? selectedDefinition.title_A : ''}
          ...
          <Col md={6}>
            <FormGroup>
              ...
              <Input
                name='titleE'
                id='titleE'
                defaultValue={selectedDefinition ? selectedDefinition.title_E : ''}
          ...
          <Col md={12}>
            <FormGroup>
              ...
              <Input
                ...
                id='contentA'
                type="textarea"
                defaultValue={selectedDefinition ? selectedDefinition.content_A : ''}
          ...
          <Col md={12}>
            <FormGroup>
              ...
              <Input
                ...
                id='contentE'
                type="textarea"
                defaultValue={selectedDefinition ? selectedDefinition.content_E : ''}
