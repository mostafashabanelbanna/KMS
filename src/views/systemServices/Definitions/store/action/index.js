...
export const addDefinition = definition => {
   ...
   definitionFormData.append('name_A', definition.name_A)
   definitionFormData.append('name_E', definition.name_E)
   definitionFormData.append('description_A', definition.description_A)
   definitionFormData.append('description_E', definition.description_E)
