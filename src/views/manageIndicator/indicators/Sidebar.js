...
//  console.log(selectedIndicator)
  ...
  return (
    <Sidebar
      size='lg'
      open={open}
      title={intl.formatMessage({id: "Add"}) + intl.formatMessage({id: "Indicator"})}
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <FormGroup>
          <Label for='acquisitionA'>
             <span className='text-danger'>*</span> {intl.formatMessage({id: "acquisitionA"})}
          </Label>
          <Input
            name='acquisitionA'
            id='acquisitionA'
        ...
        <FormGroup>
          <Label for='calculationA'>
             <span className='text-danger'>*</span> {intl.formatMessage({id: "calculationA"})}
          </Label>
          <Input
            name='calculationA'
            id='calculationA'
